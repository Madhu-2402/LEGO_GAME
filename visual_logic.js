 ...
 * Tue Apr 16 2024 16:37:06 GMT+0530 (India Standard Time)
...
var dictred, clonered, cloneblue, clonepurple, cloneyellow, dictblue, dictpurple, dictyellow;
...
function drag1() {
  registerOnDrag(clonered, false, [0,1,2], function() {}, function() {
    dragMove(clonered, 'XYZ', 'gG9+c3nh=V:eQR~uV-V|', 'Kw?RDv-0L^_3W6i[va[P');
  }, function() {}, 'Kw?RDv-0L^_3W6i[va[P');
}

// Describe this function...
function drag2() {
  registerOnDrag(cloneblue, false, [0,1,2], function() {}, function() {
    dragMove(cloneblue, 'XYZ', '%e,wuMaNCyv[teB,Z$QY', 'rPk~GBr0.~jb%B=/Tb!.');
  }, function() {}, 'rPk~GBr0.~jb%B=/Tb!.');
}
...
// Describe this function...
function drag3() {
  registerOnDrag(clonepurple, false, [0,1,2], function() {}, function() {
    dragMove(clonepurple, 'XYZ', '6zZ$[G{cp*j3P8#VtL]B', 'ui%h2(iV|6%DM%{Rn:IU');
  }, function() {}, 'ui%h2(iV|6%DM%{Rn:IU');
}

// Describe this function...
function drag4() {
  registerOnDrag(cloneyellow, false, [0,1,2], function() {}, function() {
    dragMove(cloneyellow, 'XYZ', 'O6ULpTf;rG5m?!z@xFK2', 'RyvLtlS7iP^6O9/]c%P+');
  }, function() {}, 'RyvLtlS7iP^6O9/]c%P+');
}
...
registerOnDrag('Cylinder.006', false, [0,1,2], function() {}, function() {
  dragMove('Cylinder.006', 'XYZ', '|Ye0tkWH%5jNJl@y]|*7', '5y3J^^qoDG?;*rq*aybf');
}, function() {}, '5y3J^^qoDG?;*rq*aybf');
...
registerOnDrag('Cylinder.021', false, [0,1,2], function() {}, function() {
  dragMove('Cylinder.021', 'XYZ', '1]Gm^kem/fMu2*D1Rr:a', ':-2$B=I.,$BeWpqho$8l');
}, function() {}, ':-2$B=I.,$BeWpqho$8l');
...
registerOnDrag('Cylinder.005', false, [0,1,2], function() {}, function() {
  dragMove('Cylinder.005', 'XYZ', '#G~q.XY2HF5P_`A:;WA%', '^FN%#4RxRjTSgqfe?mW!');
}, function() {}, '^FN%#4RxRjTSgqfe?mW!');

addHTMLElement('button', 'Purple', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('position', 'static', 'Purple', false);
setHTMLElemStyle('backgroundColor', 'purple', 'Purple', false);
setHTMLElemStyle('height', '60px', 'Purple', false);
setHTMLElemStyle('width', '60px', 'Purple', false);
eventHTMLElem('click', 'Purple', false, function(event) {
  changeVis('Cylinder.001', true);
});
registerOnDrag('Cylinder.001', false, [0,1,2], function() {}, function() {
  dragMove('Cylinder.001', 'XYZ', 'ls_}x4rb~fb?]G@sDQf4', '[Bh{G.?/L_j#]cQa!.RN');
}, function() {}, '[Bh{G.?/L_j#]cQa!.RN');
...
eventHTMLElem('dblclick', 'Purple', false, function(event) {
  clonepurple = cloneObject('Cylinder.001');
  changeVis(clonepurple, true);
  drag3();
});

handleAnnot(true, 'help', 'Plane', 'A user can only use the blocks with same colour' + 'If a user wants a block they can get it by clicking', 'poi1', undefined);
...
dictSet(dictblue, 'y3', getObjTransform(dictblue, false, 'position', 'z'));
dictpurple = {};
dictSet(dictpurple, 'x3', getObjTransform(dictpurple, false, 'position', 'x'));
dictSet(dictblue, 'y3', getObjTransform(dictpurple, false, 'position', 'y'));
dictSet(dictblue, 'z3', getObjTransform(dictpurple, false, 'position', 'z'));
dictyellow = {};
dictSet(dictpurple, 'x4', getObjTransform(dictyellow, false, 'position', 'x'));
dictSet(dictblue, 'y4', getObjTransform(dictyellow, false, 'position', 'y'));
dictSet(dictblue, 'z4', getObjTransform(dictyellow, false, 'position', 'z'));
